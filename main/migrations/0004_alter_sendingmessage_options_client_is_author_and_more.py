# Generated by Django 4.2 on 2024-04-09 05:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0003_alter_sendingmessage_periodicity_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='sendingmessage',
            options={'permissions': [('set_active', 'Can active')], 'verbose_name': 'Рассылка', 'verbose_name_plural': 'Рассылки'},
        ),
        migrations.AddField(
            model_name='client',
            name='is_author',
